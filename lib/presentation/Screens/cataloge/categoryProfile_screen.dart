                  ...
                  GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return ProductLargeCard(
                        index: index,
                        cartItem: CartItem(
                          id: categoryProductList[index].id,
                          name: categoryProductList[index].name,
                          image: categoryProductList[index].image,
                          price: categoryProductList[index].price,
                          prevPrice: categoryProductList[index].prevPrice,
                          discount: categoryProductList[index].discount,
                          desc: categoryProductList[index].desc,
                        ),
                        favItem: FavItem(
                          id: categoryProductList[index].id,
                          name: categoryProductList[index].name,
